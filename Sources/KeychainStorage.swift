...
enum AppSettingsStorage {
    private static let bundleID = Bundle.main.bundleIdentifier ?? "com.simplevoiceinput.app"

    private static var storageDirectory: URL {
        let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first!
        let appName = Bundle.main.object(forInfoDictionaryKey: "CFBundleName") as? String ?? "SimpleVoiceInput"
