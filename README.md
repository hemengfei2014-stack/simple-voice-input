...
<p align="center">
  <a href="https://github.com/hemengfei/simple-voice-input/releases/latest/download/SimpleVoiceInput.dmg"><b>⬇ 下载 SimpleVoiceInput.dmg</b></a><br>
...
1. 下载最新版本的 [SimpleVoiceInput.dmg](https://github.com/hemengfei/simple-voice-input/releases/latest/download/SimpleVoiceInput.dmg)
2. 双击打开 DMG 文件
